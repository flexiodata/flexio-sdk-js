/*!
 * Flex.io Javascript SDK v1.8.0 (https://github.com/flexiodata/flexio-sdk-js)
...
var taskTypes = __webpack_require__(3);
var connTypes = __webpack_require__(53);
...
var Flexio = {
  version: __webpack_require__(65).version,

  _init: function _init() {
    this.connections = __webpack_require__(66).getConnectionsObject(this);
    this.pipes = __webpack_require__(67).getPipesObject(this);
    this.util = __webpack_require__(1).getUtilObject(this);

    var getPipeConstructor = __webpack_require__(68).getPipeConstructor;
    this.pipe = getPipeConstructor(this);

    var getConnectionConstructor = __webpack_require__(69).getConnectionConstructor;
    this.connection = getConnectionConstructor(this);
  },
  setup: function setup(token, params) {
    cfg = _.assign({}, { token: token }, params);
    this._http = null;
    this._createHttp();
    return this;
  },
...
var executeFunctions = __webpack_require__(52);

module.exports = {
    input: __webpack_require__(17),
    output: __webpack_require__(17),
    convert: __webpack_require__(54),
    echo: __webpack_require__(55),
    ...
    limit: __webpack_require__(58),
    list: __webpack_require__(59),
    python: executeFunctions.python,
    render: __webpack_require__(60),
    request: __webpack_require__(61),
    select: __webpack_require__(62),
    sleep: __webpack_require__(63),
...
var executeFn = function executeFn() {
  ...
  if (_.isFunction(code)) {
    if (_.isNil(lang)) lang = 'javascript';
...
var request = function request() {
  ...
  if (_.isPlainObject(_.get(args, '[0]', {}))) {
    ...
    if (!_.isString(url)) throw 'The first parameter is required and must be a string representing the `url` or `connection` identifier.';
    ...
    params = _.assign({}, { url: url, connection: connection }, params);
  }

...
module.exports._ = {
  ...
  isEqual: __webpack_require__(31),
  defaultTo: __webpack_require__(32)
};
...
var Flexio = __webpack_require__(14);
...
var task = __webpack_require__(52);
...
var Flexio = {
  ...
  _init: function _init() {
    this.connections = __webpack_require__(82).getConnectionsObject(this);
    this.pipes = __webpack_require__(83).getPipesObject(this);
    this.util = __webpack_require__(1).getUtilObject(this);
    this._http = null;

    var getPipeConstructor = __webpack_require__(84).getPipeConstructor;
    this.pipe = getPipeConstructor(this);


    var getConnectionConstructor = __webpack_require__(85).getConnectionConstructor;
...
var createFn = __webpack_require__(53);
var convertFn = __webpack_require__(54);
var copyFn = __webpack_require__(55);
var dumpFn = __webpack_require__(56);
var echoFn = __webpack_require__(57);
var emailFn = __webpack_require__(58);
var executeFn = __webpack_require__(59);
var filterFn = __webpack_require__(64);
var foreachFn = __webpack_require__(65);
var insertFn = __webpack_require__(66);
var limitFn = __webpack_require__(67);
var mergeFn = __webpack_require__(68);
var mkdirFn = __webpack_require__(69);
var listFn = __webpack_require__(70);
var readFn = __webpack_require__(71);
var renderFn = __webpack_require__(72);
var requestFn = __webpack_require__(73);
var selectFn = __webpack_require__(74);
var sequenceFn = __webpack_require__(75);
var setFn = __webpack_require__(76);
var sleepFn = __webpack_require__(77);
var taskFn = __webpack_require__(78);
var transformFn = __webpack_require__(79);
var writeFn = __webpack_require__(80);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(5), __webpack_require__(60).Buffer))
...
module.exports = {"name":"flexio-sdk-js","version":"1.20.2","description":"Javascript SDK for managing Flex.io resources and services","author":"David Z. Williams <dave@flex.io>","--main":"dist/flexio-node.js","main":"src/main.js","--browser":"src/main.js","browser":"dist/flexio.min.js","scripts":{"dev":"cross-env build=development webpack-dev-server --config ./build/webpack.dev.js --open --inline --https --hot","build:debug":"cross-env build=debug webpack --config build/webpack.dist.js","build:release":"cross-env build=production webpack --config build/webpack.dist.js","build:examples":"webpack --config build/webpack.examples.js","build":"npm run build:debug && npm run build:release && npm run build:examples","test":"echo \"Error: no test specified\" && exit 1"},"repository":{"type":"git","url":"git+https://github.com/flexiodata/flexio-sdk-js.git"},"keywords":[],"license":"Apache-2.0","bugs":{"url":"https://github.com/flexiodata/flexio-sdk-js/issues"},"homepage":"https://github.com/flexiodata/flexio-sdk-js/","dependencies":{"axios":"^0.16.2","lodash.assign":"^4.2.0","lodash.defaultto":"^4.14.0","lodash.foreach":"^4.5.0","lodash.get":"^4.4.2","lodash.has":"^4.5.2","lodash.includes":"^4.3.0","lodash.isarray":"^4.0.0","lodash.isequal":"^4.5.0","lodash.isfunction":"^3.0.9","lodash.isnil":"^4.0.0","lodash.isnumber":"^3.0.3","lodash.isplainobject":"^4.0.6","lodash.isstring":"^4.0.1","lodash.last":"^3.0.0","lodash.map":"^4.6.0","lodash.omit":"^4.5.0","lodash.pick":"^4.4.0","lodash.set":"^4.3.2","vue-highlightjs":"^1.3.3"},"devDependencies":{"autoprefixer":"^7.1.4","babel-core":"^6.26.0","babel-loader":"^7.1.2","babel-plugin-lodash":"^3.2.11","babel-plugin-transform-es2015-destructuring":"^6.23.0","babel-plugin-transform-es2015-parameters":"^6.24.1","babel-plugin-transform-object-rest-spread":"^6.26.0","babel-plugin-transform-runtime":"^6.23.0","babel-preset-env":"^1.6.0","babel-preset-es2015":"^6.24.1","babel-preset-stage-2":"^6.24.1","cross-env":"^5.0.5","css-loader":"^0.28.7","deep-assign":"^2.0.0","vue":"^2.4.4","vue-loader":"^13.0.4","vue-simple-spinner":"^1.2.7","vue-style-loader":"^3.0.3","vue-template-compiler":"^2.4.4","webpack":"^3.5.5","webpack-bundle-analyzer":"^2.11.1","webpack-dev-server":"^2.8.2"}}
